...
public class JobSeeerAdapter extends FirebaseRecyclerAdapter<
        JobAvailable, JobSeeerAdapter.jobViewholder> {
    Context c;
    ...
    public jobViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new JobSeeerAdapter.jobViewholder(view);
    }
